      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className={`text-3xl md:text-4xl font-bold text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <DoodleUnderline thickness={3} animated={true}>My Projects</DoodleUnderline>
          </h2>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-10">
            ...
            <div className="w-full md:w-1/3 space-y-4 order-2 md:order-1">
              {PROJECTS.map((project, index) => (
                ...
                >
                  ...
                  >
                    <div className={`h-full flex flex-col justify-center transition-all duration-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`} style={{ transitionDelay: `${200 + index * 100}ms` }}>
            ...
            <div className="w-full md:w-2/3 order-1 md:order-2">
              <DoodleBorder className="bg-background h-full" animated={true}>
